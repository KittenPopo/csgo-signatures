[CLIENT.dll] {
	...
	C_PlayerAnimState::CacheSequences() = "55 8B EC 83 E4 F8 83 EC 34 53 56 8B F1 57 8B";
	C_PlayerAnimState::CreateAnimationState() = "55 8B EC 56 8B F1 B9 ? ? ? ? C7 46";
	C_PlayerAnimState::ModifyEyePosition() = "55 8B EC 83 E4 F8 83 EC 5C 53 8B D9 56 57 83"; 
	C_PlayerAnimState::SetUpAimMatrix() = "55 8B EC 81 EC ? ? ? ? 53 56 57 8B 3D"; 
	C_PlayerAnimState::SetUpLean() = "55 8B EC 83 E4 F8 A1 ? ? ? ? 83 EC 20 F3"; 
	C_PlayerAnimState::SetUpMovement() = "8B EC 83 E4 F8 81 EC ? ? ? ? 56 57 8B 3D ? ? ? ? 8B " - 1; 
	C_PlayerAnimState::SetUpVelocity() = "55 8B EC 83 E4 F8 83 EC 30 56 57 8B 3D"; 
	C_PlayerAnimState::SetUpWeaponAction() = "55 8B EC 51 53 56 57 8B F9 8B 77 60"; 
	C_PlayerAnimState::SetUpWholeBodyAction() = "55 8B EC 83 EC 08 56 57 8B F9 8B 77"; 
	C_PlayerAnimState::SetupMovement() = "8B EC 83 E4 F8 83 EC 0C 53 56 57 8B 7D 08 8B F1 F3" - 1;
