MODULE::CLIENT {
	...
	BuildTransformations() = "83 E4 F0 81 EC ? ? ? ? 56 57 8B F9 8B 0D ? ? ? ? 89" - 1; 
	...
	CBaseEntity::EmitSound() = "55 8B EC 83 EC 4C 53 8B D9 8B "; 
	...
	FrameStageNotify() = "55 8B EC 8B 0D ? ? ? ? 8B 01 8B 80 ? ? ? ? FF D0 A2"; 
	GetEyePosition() = "55 8B EC 56 8B 75 08 57 8B F9 56 8B 07 FF 90"; 
	...
	GetViewmodelFOV() = "55 8B EC 8B 0D ? ? ? ? 83 EC 08 57"; 
	...
	LookupSequence() = "85 C0 74 07 8B CE E8 ? ? ? ? 8B B6 ? ? ? ? 85 F6 74" - 0x18; 
	ModifyEyePosition() = "55 8B EC 83 E4 F8 83 EC 5C 53 8B D9 56 57 83"; 
	...
	SetUpMovement() = "8B EC 83 E4 F8 81 EC ? ? ? ? 56 57 8B 3D ? ? ? ? 8B " - 1; 
