[CLIENT.dll] {
	...
	C_BaseEntity::SetAbsAngles() = "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"; 
	C_BaseEntity::SetAbsOrigin() = "55 8B EC 83 E4 F8 51 53 56 57 8B F1"; 
	C_BaseEntity::SetDormant() = "55 8B EC 53 8B 5D 08 56 8B F1 88 9E ? ? 00 00"; 
	C_BaseEntity::ShouldInterpolate() = "A1 ? ? ? ? 56 57 8B F9 8B 30 8D 4F 08"; 
	C_BaseEntity::DrawBrushModel() = "68 ? ? ? ? 6A 00 68 ? ? ? ? FF 15 ? ? ? ? 8B 45" - 0x1C; 
	C_BaseEntity::InterpolateServerEntities() = "55 8B EC 83 EC 1C 8B 0D ? ? ? ? 53 "; 
	C_CSGOPlayerAnimationState::ModifyEyePosition() = "55 8B EC 83 E4 F8 83 EC 5C 53 8B D9 56 57 83"; 
	C_CSGOPlayerAnimationState::SetUpAimMatrix() = "55 8B EC 81 EC ? ? ? ? 53 56 57 8B 3D"; 
	C_CSGOPlayerAnimationState::SetUpLean() = "55 8B EC 83 E4 F8 A1 ? ? ? ? 83 EC 20 F3"; 
	C_CSGOPlayerAnimationState::SetUpMovement() = "8B EC 83 E4 F8 81 EC ? ? ? ? 56 57 8B 3D ? ? ? ? 8B " - 1; 
	C_CSGOPlayerAnimationState::SetUpVelocity() = "55 8B EC 83 E4 F8 83 EC 30 56 57 8B 3D"; 
	C_CSGOPlayerAnimationState::SetUpWeaponAction() = "55 8B EC 51 53 56 57 8B F9 8B 77 60"; 
	C_CSGOPlayerAnimationState::SetUpWholeBodyAction() = "55 8B EC 83 EC 08 56 57 8B F9 8B 77"; 
	C_CSGOPlayerAnimationState::SetupMovement() = "8B EC 83 E4 F8 83 EC 0C 53 56 57 8B 7D 08 8B F1 F3" - 1;
	C_CSGOPlayerAnimationState::CreateAnimationState() = "55 8B EC 56 8B F1 B9 ? ? ? ? C7 46";
	C_CSGOPlayerAnimationState::Update() = "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3"; 
	C_CSGOPlayerAnimationState::CacheSequences() = "55 8B EC 83 E4 F8 83 EC 34 53 56 8B F1 57 8B";
	...
	C_BaseAnimating::MaintainSequenceTransitions() = "55 8B 6B 04 89 6C 24 04 8B EC 83 EC 18 56 57 8B F9 F3" - 0xC;
